...
<?php
    ...
    $row = mysqli_fetch_assoc($result);
        $userquery="select * from users where username='$uname'";
...
<div class="container-fluid bg-light p-2">
        <div class="row justify-content-center">
            <div class="col-md-8 mt-2 position-relative">
                <b style="font-size:16px;">Total Price: </b><div class="price-container" id="pd">$<?php echo $row2['price'];?>.00</div>
                <div class="card p-2">
                    <div class="card-body">
                        ...
                        <form action="processbooking.php" method="post">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="firstName" value="<?php echo $userrow['first_name'];?>" name="fn" placeholder="Enter first name" Required>
                                    <input type="number" value="<?php echo $row2['price'];?>" name="pr" hidden>

                                </div>
                                <div class="col-md-6">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="lastName" value="<?php echo $userrow['last_name'];?>" name="ln" placeholder="Enter last name" Required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="email" class="form-label">Email address</label>
                                    <input type="email" class="form-control" id="email" value="<?php echo $userrow['email'];?>" name="em" placeholder="Enter email" Required>
                                </div>
                                <div class="col-md-6">
                                    <label for="phoneNumber" class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" id="phoneNumber" value="<?php echo $userrow['phone'];?>" name="ph" placeholder="Enter phone number" Required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="address" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="address" value="<?php echo $userrow['address'];?>" name="ad" placeholder="Enter address" Required>
                                </div>
                                <div class="col-md-6">
                                <label for="address" class="form-label">Country</label>
                                      <select class="form-control" id="country" name="co" Required>
                            ...
                            <div class="row mb-3">
                            <div class="col-md-6">
                              <label for="checkInDate" class="form-label">Room Name</label>
                              <input type="text" class="form-control" id="roomname" value="<?php echo $row2['room_name'];?>" disabled>
                              <input type="text" name="room_id" value="<?php echo $row2['room_id'];?>" hidden>
                            </div>
                                <div class="col-md-6">
                                    <label for="hotel_name" class="form-label">Hotel</label>
                                    <input type="text" class="form-control" value="<?php echo $row['hotel_name'];?>" disabled>
                                    <input type="text" name="hotel_name" value="<?php echo $row['hotel_name']; ?>" hidden>
                                </div>
                            </div>
                            <div class="row mb-3">
                            <div class="col-md-6">
                              <label for="checkInDate" class="form-label">Check-in Date</label>
                              <input type="date" class="form-control" id="checkInDate" name="cdate" min="" Required>
                            </div>
                                <div class="col-md-6">
                                    <label for="noOfDays" class="form-label">No of Days for Stay</label>
                                    <input type="number" class="form-control" id="ndays" name="days" value="1" placeholder="1" min="1">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="d-flex">
                                    <button type="submit" class="btn" style="background-color:#9a3d6e;color:white;border: 1px solid #9a3d6e">Confirm Booking</button>
                                    <button type="reset" style="margin-left:20px;" class="btn btn-secondary">Cancel</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="processbooking.php" method="post">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="firstName" class="form-label">First Name</label>
                                    <input type="text" class="form-control" id="firstName" name="fn" placeholder="Enter first name" Required>
                                    <input type="number" value="<?php echo $row2['price'];?>" name="pr" hidden>

                                </div>
                                <div class="col-md-6">
                                    <label for="lastName" class="form-label">Last Name</label>
                                    <input type="text" class="form-control" id="lastName" name="ln" placeholder="Enter last name" Required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="email" class="form-label">Email address</label>
                                    <input type="email" class="form-control" id="email" name="em" placeholder="Enter email" Required>
                                </div>
                                <div class="col-md-6">
                                    <label for="phoneNumber" class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" id="phoneNumber" name="ph" placeholder="Enter phone number" Required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="address" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="address" name="ad" placeholder="Enter address" Required>
                                </div>
                                <div class="col-md-6">
                                <label for="address" class="form-label">Country</label>
                                      <select class="form-control" id="country" name="co" Required>
...
<div class="container-fluid footerbg mt-5">
 ...
 <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js"></script>
    ...
    <script>
        const pricePerDay = <?php echo $row2['price'];?>; // Set your price per day
        const noOfDaysInput = document.getElementById('ndays');
        const priceDisplay = document.getElementById('pd');

        function updatePrice() {
            const noOfDays = parseInt(noOfDaysInput.value) || 0;
            const totalPrice = pricePerDay * noOfDays;
            pd.textContent = `$${totalPrice.toFixed(2)}`;
        }
